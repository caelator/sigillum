...
| Approvals and revokes | Bounded ERC-20 allowance probes and NFT operator-approval probes for operator-supplied addresses, persisted as approval holdings with risk findings | Revoke.cash, Rabby | ERC-20, Permit2, NFT operator discovery, risky spender labels, simulation, and revoke recommendations |
