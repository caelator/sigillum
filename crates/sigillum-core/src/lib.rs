...
pub use ethereum_stealth::{
    ...
    check_ethereum_stealth_address_watch_only, decode_erc5564_metadata_hints,
    decode_quantity_hex, derive_sigillum_ethereum_stealth_gas_sponsor,
    derive_sigillum_ethereum_stealth_wallet, derive_watch_only_sigillum_ethereum_stealth_wallet,
    encode_erc5564_announce_calldata, encode_erc5564_metadata_erc20_transfer,
    encode_erc5564_metadata_native, generate_ethereum_stealth_address, sign_ethereum_call,
